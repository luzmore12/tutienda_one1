    ...
    <div ref={showDivRef} className="addproducts__container">
      <div className="left-side">
        <div className="check-out-container">
          <div className="check-out-print">
            <h1 className="check-out-title">Tutienda-one1</h1>
           
            <table>
              <thead>
                <tr>
                  <th>No.</th>
                  <th className="table-item-title">Nombre del árticulo</th>
                  <th>Precio</th>
                  <th>Cantidad</th>
                </tr>
              </thead>
      ...
      <div className="right-side">
        <div className="right-side-header">
          ...
          Tutienda <span className="total-items">{items.length}</span>
